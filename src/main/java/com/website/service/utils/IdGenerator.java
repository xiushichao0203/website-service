...
public class IdGenerator {
     ...
     */
    IdGenerator() {
        System.out.println(String.format("当前工作组编号[%d], 数据中心编号[%d]", new Object[]{workerId, datacenterId}));
    }
        ...
        if (timestamp < lastTimestamp) {
            if (lastTimestamp - timestamp < 1000) {
                try{
                    ...
                    throw new RuntimeException("Thread runtime is error");
                }
